...
function setSpeed() {
    var speed = document.getElementById("dbear").value;
    bear.dBear=speed;
    window.alert("You've changed the speed of the bear to : " +" " +bear.dBear);
} 
...
function createBeeImg(wNum) {
    ...
    img.setAttribute("src", "sprites/bee.gif");
...
function updateBees() { // update loop for game
    ...
    if(Number(check)>=1000){
        ...
        updateTimer = setTimeout('updateBees()', Number(period));
    }
